...
#include <VPolynomialMulByXaiWrap.h>
#include <tfhe++.hpp>

void clock(VPolynomialMulByXaiWrap *dut, VerilatedFstC* tfp){
...
int main(int argc, char** argv) {
  ...
  VPolynomialMulByXaiWrap *dut = new VPolynomialMulByXaiWrap();
  ...
  // constexpr uint32_t exponent = 1;
  TFHEpp::PolynomialMulByXai<TFHEpp::lvl1param>(res[0],trlwe[0],exponent);
  TFHEpp::PolynomialMulByXai<TFHEpp::lvl1param>(res[1],trlwe[1],exponent);
  ...
  for(int i = 0; i < TFHEpp::lvl1param::k+1; i++)
