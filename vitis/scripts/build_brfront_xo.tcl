...
# Build BRFront XO file (stream-only kernel, no DataMover IPs needed)
...
# Import RTL sources
import_files -norecurse [list ${rtl_dir}/HomGateWrap.v ${rtl_dir}/BRFront_top.v]
set_property top BRFront [current_fileset]
...
puts "BRFront XO built successfully: ${xo_file}"
